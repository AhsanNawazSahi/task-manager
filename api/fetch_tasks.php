...
if(isset($_GET['search_query']) && !empty($_GET['search_query'])) {
    ...
    $query = "SELECT * FROM tasks WHERE title LIKE '%$search_query%' AND task_status = 'incomplete'";
    ...
    // If no search query is provided, fetch all incomplete tasks
    $query = "SELECT * FROM tasks WHERE task_status = 'incomplete'";
    $result = mysqli_query($conn, $query);
    ...
    $query = "SELECT * FROM tasks WHERE task_status LIKE 'incomplete'";
    $result = mysqli_query($conn, $query);
